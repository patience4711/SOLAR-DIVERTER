...
#bo {width:100%; height:100%; position: absolute; left:0; top:0; background-color:rgba(192,192,192,0.9); color:white; z-index:10; font-size: 90px;  font-weight: bold; text-align: center; display: none;} 
...
.bt:hover, .bt_small:hover {background-color: #66ff33;}

.bt:active,.bt_small:active{
...
.sb1 { font-size:20px; height:29px; } 
...
#menu #sub { float: left; background:green; display:none }
...
.close { color: red !important; position: static; float:right; width:58px; font-size: 42px; font-weight: bold; cursor: pointer;}
